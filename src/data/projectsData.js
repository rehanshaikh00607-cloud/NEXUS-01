...
export const PROJECTS_DATA = [
  {
    ...
    screenshot: `${import.meta.env.BASE_URL}projects/ai-study-assistant.jpg`,
    ...
    status: "ACTIVE",
    metrics: "500+ Study Sessions // Sub-Second Response Streaming",
    caseStudy: {
  ...
  },
  {
    ...
    screenshot: `${import.meta.env.BASE_URL}projects/ecommerce-website.jpg`,
    githubUrl: "https://github.com/rehanshaikh00607-cloud/ecommerce-website",
    liveDemoUrl: "https://rehanshaikh00607-cloud.github.io/NEXUS-01/",
    category: "Full-Stack & 3D",
    status: "COMPLETED",
    metrics: "Smooth 60 FPS 3D WebGL // Under 1.5s Initial Load",
    caseStudy: {
  ...
  },
  {
    ...
    screenshot: `${import.meta.env.BASE_URL}projects/developer-dashboard.jpg`,
    githubUrl: "https://github.com/rehanshaikh00607-cloud/developer-dashboard",
    liveDemoUrl: "https://rehanshaikh00607-cloud.github.io/NEXUS-01/",
    category: "DevOps & Tools",
    status: "ACTIVE",
    metrics: "Real-Time WebSocket Streams (<50ms Latency) // Zero Dropped Events",
    caseStudy: {
