...
/**
 * SpaceStation
 * 3D procedural orbital station representing the Skills destination,
 * featuring a rotating toroidal habitat ring, photovoltaic solar panels,
 * and navigation beacons.
 */
function SpaceStationComponent({
  position = [-22, 8, -26],
  rotation = [0.2, 0.4, 0],
  scale = 1,
  rotationSpeed = 0.2
...
const SpaceStation = memo(SpaceStationComponent)
